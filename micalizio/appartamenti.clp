...
(deffacts APPARTAMENTI::the-apartment
    ...
    (apartment  (name "Appartamento su due piani in vendita in strada dei Cunioli Alti, 137")
                ...
                (ascensore no) (boxauto si) (metri-quadri-boxauto 3) (terrazzino si) (prezzorichiesto 375000)
    )
    ...
    (apartment  (name "Quadrilocale in vendita in strada Genova, 255 /4")
                ...
                (ascensore si) (boxauto si) (metri-quadri-boxauto 5) (terrazzino si) (prezzorichiesto 240000)
    )
    ...
    (apartment  (name "Trilocale in vendita in strada Genova, 208")
                ...
                (ascensore no) (boxauto si) (metri-quadri-boxauto 3) (terrazzino si) (prezzorichiesto 157000)
    )
    ...
    (apartment  (name "Attico in vendita in via Onorato Vigliani, 24")
                ...
                (ascensore si) (boxauto si) (metri-quadri-boxauto 7) (terrazzino si) (prezzorichiesto 465000)
    )
    ...
    (apartment  (name "Appartamento in vendita in via Filadelfia, 50")
                ...
                (ascensore si) (boxauto si) (metri-quadri-boxauto 4) (terrazzino si) (prezzorichiesto 260000)
    )
    ...
    (apartment  (name "Appartamento su due piani in vendita in via Matteo Civitali, 41")
                ...
                (ascensore no) (boxauto si) (metri-quadri-boxauto 4) (terrazzino no) (prezzorichiesto 450000)
    )
    ...
    (apartment  (name "Appartamento in vendita in piazza Santa Maria Nascente s.n.c")
                ...
                (ascensore no) (boxauto si) (metri-quadri-boxauto 6) (terrazzino no) (prezzorichiesto 890000)
    )
    ...
    (apartment  (name "Trilocale in vendita in via San Calocero, 9")
                ...
                (ascensore si) (boxauto si) (metri-quadri-boxauto 6) (terrazzino no) (prezzorichiesto 950000)
    )
    ...
    (apartment  (name "Bilocale in vendita in piazza Ventiquattro Maggio s.n.c")
                ...
                (ascensore no) (boxauto si) (metri-quadri-boxauto 4) (terrazzino si) (prezzorichiesto 235000)
    )
    ...
    (apartment  (name "Bilocale in vendita in piazza Ventiquattro Maggio s.n.c")
                ...
                (ascensore no) (boxauto si) (metri-quadri-boxauto 6) (terrazzino si) (prezzorichiesto 500000)
    )
    ...
    (apartment  (name "Monolocale in vendita in via di Rocca Tedalda s.n.c")
                ...
                (ascensore no) (boxauto si) (metri-quadri-boxauto 6) (terrazzino si) (prezzorichiesto 168000)
    )
)
