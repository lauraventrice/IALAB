...
(deffacts APPARTAMENTI::the-apartment
    ...
    (apartment  (name "TORINO Appartamento su due piani in vendita in strada dei Cunioli Alti, 137")
    ...
    (apartment  (name "TORINO Appartamento su tre piani in vendita via Abramo Lincoln, 160b")
    ...
    (apartment  (name "TORINO Quadrilocale in vendita in strada Genova, 255 /4")
    ...
    (apartment  (name "TORINO Trilocale in vendita in strada Genova, 208")
    ...
    (apartment  (name "TORINO Appartamento su due piani in vendita in strada dei Pinguini tattici Nucleari")
    ...
    (apartment  (name "TORINO Quadrilocale in vendita in strada delle Gazzelle, 45")
    ...
    (apartment  (name "TORINO Monolocale in vendita in strada Ranieri, 12")
    ...
    (apartment  (name "TORINO Attico in vendita in via Onorato Vigliani, 24")
    ...
    (apartment  (name "TORINO Trilocale in vendita in via Fratel Teodoreto, 3")
    ...
    (apartment  (name "TORINO Appartamento in vendita in via Filadelfia, 50")
    ...
    (apartment  (name "TORINO Attico in vendita in via Roma, 43")
    ...
    (apartment  (name "TORINO Trilocale in vendita in via Madama Cristina, 28")
    ...
    (apartment  (name "TORINO Appartamento in vendita in via Toledo, 10")
    ...
    (apartment  (name "ROMA Appartamento in vendita in via di San Crisogono")
    ...
    (apartment  (name "ROMA Appartamento in vendita in via del Corso, 302")
                (metriquadri 102) (numerovani 2) (numeroservizi 2) (piano 1) (citta roma) (zona primacintura) (quartiere trastevere)
                (ascensore no) (boxauto si)  (terrazzino si) (prezzorichiesto 355000) (servizivicino parco scuola mezzipubblici palestra)
    )

    
    (apartment  (name "ROMA Trilocale in vendita in vicolo del Bologna s.n.c")
                (metriquadri 68) (numerovani 2) (numeroservizi 2) (piano 0) (citta roma) (zona primacintura) (quartiere trastevere)
                (ascensore no) (boxauto si) (terrazzino no) (prezzorichiesto 315000) (servizivicino ospedale scuola parco palestra) ; questo appartamento non ha il boxauto e quindi non ha specificato la grandezza di esso
    )

    
    (apartment  (name "ROMA Bilocale in vendita in via del Politeama")
    ...
    (apartment  (name "ROMA Bilocale in vendita in piazza Gae Aulenti, 12")
    ...
    (apartment  (name "ROMA Quadrilocale in vendita in via fori imperiali")
    ...
    (apartment  (name "ROMA Bilocale in vendita a Aventino - San Saba")
    ...
    (apartment  (name "ROMA Attico in vendita in via Domenico Modugno, 178b")
                (metriquadri 170) (numerovani 3) (numeroservizi 2) (piano 3) (citta roma) (zona periferia) (quartiere campitelli)
                (ascensore si) (boxauto si)  (terrazzino si) (prezzorichiesto 465000) (servizivicino ospedale mezzipubblici)
    )

    
    (apartment  (name "ROMA Trilocale in vendita in via Leonardo da Vinci, 3")
    ...
    (apartment  (name "ROMA Appartamento in vendita in via Milano, 50")
                (metriquadri 130) (numerovani 3) (numeroservizi 2) (piano 1) (citta roma) (zona periferia) (quartiere campitelli)
                (ascensore si) (boxauto si)  (terrazzino si) (prezzorichiesto 260000) (servizivicino ospedale mezzipubblici palestra)
    )
  
    (apartment  (name "ROMA Appartamento in vendita in via Lago d'Iseo, 21")
                (metriquadri 120) (numerovani 2) (numeroservizi 3) (piano 1) (citta roma) (zona centro) (quartiere campitelli)
                (ascensore no) (boxauto si)  (terrazzino si) (prezzorichiesto 320000) (servizivicino parco scuola mezzipubblici)
    )

    ; lista appartamenti a san siro (milano)
    
    (apartment  (name "MILANO Appartamento in vendita in via Castel del Monte")
                (metriquadri 145) (numerovani 3) (numeroservizi 2) (piano 2) (citta milano) (zona centro) (quartiere sansiro)
                (ascensore no) (boxauto si)  (terrazzino si) (prezzorichiesto 430000) (servizivicino parco scuola mezzipubblici)
    )


    (apartment  (name "MILANO Bilocale in vendita in piazza Margana, 20")
    ...
    (apartment  (name "MILANO Appartamento su due piani in vendita in via Matteo Civitali, 41")
    ...
    (apartment  (name "MILANO Appartamento in vendita in piazza Santa Maria Nascente s.n.c")
    ...
    (apartment  (name "MILANO Quadrilocale in vendita in via Enrico VIII")
    ...
    (apartment  (name "MILANO Bilocale in vendita in zona San Siro")
    ...
    (apartment  (name "MILANO Attico in vendita in via Arborelli")
    ...
    (apartment  (name "MILANO Appartamento in vendita in via Cassano delle Murge")
                (metriquadri 145) (numerovani 2) (numeroservizi 2) (piano 3) (citta milano) (zona primacintura) (quartiere navigli)
                (ascensore no) (boxauto si)  (terrazzino si) (prezzorichiesto 430000) (servizivicino parco mezzipubblici)
    )

    (apartment  (name "MILANO Trilocale in vendita in via San Calocero, 9")
    ...
    (apartment  (name "MILANO Bilocale in vendita in piazza Ventiquattro Maggio s.n.c")
    ...
    (apartment  (name "MILANO Monolocale in vendita in piazza Serafino Belfanti, 1")
    ...
    (apartment  (name "MILANO Attico in vendita in via Giacomo Leopardi, 26")
                (metriquadri 320) (numerovani 3) (numeroservizi 2) (piano 0) (citta milano) (zona centro) (quartiere navigli)
                (ascensore si) (boxauto si)  (terrazzino si) (prezzorichiesto 613000) (servizivicino ospedale scuola mezzipubblici)
    )
    
    (apartment  (name "MILANO Trilocale in vendita in via D'orazio, 92a")
                (metriquadri 79) (numerovani 3) (numeroservizi 2) (piano 1) (citta milano) (zona primacintura) (quartiere navigli)
                (ascensore si) (boxauto si) (terrazzino no) (prezzorichiesto 134500) (servizivicino parco scuola ospedale palestra) 
    )

  
    (apartment  (name "MILANO Appartamento in vendita in via Della chiesa, 110")
    ...
    (apartment  (name "FIRENZE Appartamento in vendita in via Sant'Eramo")
                (metriquadri 158) (numerovani 3) (numeroservizi 3) (piano 3) (citta firenze) (zona centro) (quartiere santacroce)
                (ascensore no) (boxauto si)  (terrazzino si) (prezzorichiesto 430000) (servizivicino parco mezzipubblici scuola ospedale)
    )

    (apartment  (name "FIRENZE Trilocale in vendita in Campo San Giacomo da l'Orio s.n.c")
    ...
    (apartment  (name "FIRENZE Quadrilocale in vendita in Santa Croce")
    ...
    (apartment  (name "FIRENZE Bilocale in vendita a Santa Croce")
    ...
    (apartment  (name "FIRENZE Bilocale in vendita in piazza Botticelli")
    ...
    (apartment  (name "FIRENZE Monolocale in vendita in piazza Michelangelo, 31")
    ...
    (apartment  (name "FIRENZE Appartamento in vendita in via Altamura")
                (metriquadri 107) (numerovani 2) (numeroservizi 1) (piano 0) (citta firenze) (zona primacintura) (quartiere rovezzano)
                (ascensore no) (boxauto si)  (terrazzino si) (prezzorichiesto 390000) (servizivicino parco mezzipubblici ospedale)
    )
    
    (apartment  (name "FIRENZE Quadrilocale in vendita in via SANT'ANDREA A ROVEZZANO s.n.c")
    ...
    (apartment  (name "FIRENZE Bilocale in vendita in Piazza Benedetto da Rovezzano")
    ...
    (apartment  (name "FIRENZE Monolocale in vendita in via di Rocca Tedalda s.n.c")
...
(defrule APPARTAMENTI::generate-apartments
  ...
  (attribute (name best-numero-piano) (value ?p) (certainty ?certainty-20))
  ...
  (assert (attribute (name apartment) (value ?name)
                     (certainty (min ?certainty-1 ?certainty-2 ?certainty-3 ?certainty-5 ?certainty-6 ?certainty-7 ?certainty-8 ?certainty-9 ?certainty-11 ?certainty-12 ?certainty-13 ?certainty-20)))))
