...
5 {partita(Squadra1, Squadra2) : squadra(Squadra2), Squadra1 <> Squadra2} 5:- squadra(Squadra1). %ADESSO HO TUTTE LE PARTITE CREATE TOTALI
...
:- assegnaAGiornata(G, SquadraCasa1, SquadraOspite1), assegnaAGiornata(G, SquadraCasa2, SquadraOspite2), SquadraOspite1 <> SquadraOspite2, squadraInCitta(SquadraCasa1, Citta1), squadraInCitta(SquadraCasa2, Citta2),  Citta1 == Citta2.
