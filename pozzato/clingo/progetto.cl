...
% 1 {partita(G, Citta, SquadraCasa, SquadraTrasferta) : citta(Citta), giornata(G), squadra(SquadraTrasferta)} 1 :- squadra(SquadraCasa).
% 1 {partita(G, Citta, SquadraCasa, SquadraTrasferta) : citta(Citta), squadra(SquadraCasa), giornata(G)} 1 :- squadra(SquadraTrasferta).

% :- partita(G, Citta, SquadraCasa, SquadraTrasferta), squadraInCitta(SquadraCasa, CittaSquadraCasa), CittaSquadraCasa <> Citta.
...
% non possiamo avere partite in cui la squadra di casa è uguale alla suqasquadradra ospite
...
% una squadra non può gocare due partite diverse nella stessa giornata
